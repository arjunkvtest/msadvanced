...
t2 = threading.Thread(target=runUsPc, args=(35,26,48))
t3 = threading.Thread(target=runUsPc, args=(35,55,75))
...
t2 = threading.Thread(target=runUsMob, args=(22,26,48))
t3 = threading.Thread(target=runUsMob, args=(22,55,75))
