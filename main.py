...
t1 = threading.Thread(target=runUsPc, args=(35,1,15))
t2 = threading.Thread(target=runUsPc, args=(35,16,30))
t3 = threading.Thread(target=runUsPc, args=(35,31,50))
t4 = threading.Thread(target=runUsPc, args=(35,51,69))
t1.start()
t2.start()
t3.start()
t4.start()
...
t3.join()
t4.join()
t1 = threading.Thread(target=runUsMob, args=(22,1,15))
t2 = threading.Thread(target=runUsMob, args=(22,16,30))
t3 = threading.Thread(target=runUsMob, args=(22,31,50))
t4 = threading.Thread(target=runUsMob, args=(22,51,69))
t1.start()
t2.start()
t3.start()
t4.start()
