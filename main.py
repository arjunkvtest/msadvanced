...
t3 = threading.Thread(target=runUsPc, args=(35,31,45))
t4 = threading.Thread(target=runUsPc, args=(35,46,65))
t1.start()
t2.start()
t3.start()
t4.start()
...
t3 = threading.Thread(target=runUsMob, args=(22,31,45))
t4 = threading.Thread(target=runUsMob, args=(22,46,65))
t1.start()
t2.start()
t3.start()
t4.start()
